...
public class TeamsListtoAddNewPlayerAdapter extends BaseAdapter {


    private Context mContext;
    private ArrayList<String> mArrSchoolData;

    public TeamsListtoAddNewPlayerAdapter(Context context, ArrayList arrSchoolData) {
        super();
        mContext = context;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        view = inflater.inflate(R.layout.teams_screen_for_adding_new_players, parent, false);


        // get the reference of textView and button
        TextView txtSchoolTitle = (TextView) view.findViewById(R.id.txtTeamsList);
        Button btnAction = (Button) view.findViewById(R.id.SelectTeambtn);
        ...
        btnAction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(view.getContext(), AddNewPlayerinTeamScreen.class);
