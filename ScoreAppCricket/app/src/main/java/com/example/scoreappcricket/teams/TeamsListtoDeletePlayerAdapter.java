...
public class TeamsListtoDeletePlayerAdapter extends BaseAdapter {


    private Context mContext;
    private ArrayList<String> mArrSchoolData;

    public TeamsListtoDeletePlayerAdapter(Context context, ArrayList arrSchoolData) {
        super();
        mContext = context;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        view = inflater.inflate(R.layout.teams_screen_for_deleting_players, parent, false);
        ...
        btnAction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(view.getContext(), DeletePlayerfromTeamScreen.class);
