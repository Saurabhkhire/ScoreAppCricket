...
public class TeamsListtoAddNewPlayerScreen extends AppCompatActivity {

    private ListView mListview;
    private ArrayList<String> mArrData;
    private TeamsListtoAddNewPlayerAdapter mAdapter;
    private TeamDatabase dbHandler;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.teams_list_for_adding_new_players);

        mListview = (ListView) findViewById(R.id.listTeams);

        dbHandler = new TeamDatabase(TeamsListtoAddNewPlayerScreen.this);
      ...
      //mArrData = new ArrayList<String>(Arrays.asList("111,222,333,444,555,666".split(",")));
        ...
        mAdapter = new TeamsListtoAddNewPlayerAdapter(TeamsListtoAddNewPlayerScreen.this, mArrData);
