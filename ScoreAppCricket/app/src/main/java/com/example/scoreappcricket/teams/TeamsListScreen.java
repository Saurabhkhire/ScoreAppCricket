...
public class TeamsListScreen extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        dbHandler = new TeamDatabase(TeamsListScreen.this);
      ...
      //mArrData = new ArrayList<String>(Arrays.asList("111,222,333,444,555,666".split(",")));
        ...
        mAdapter = new TeamsListAdapter(TeamsListScreen.this, mArrData);
